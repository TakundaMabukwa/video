...
CREATE INDEX idx_videos_device_channel_time ON videos(device_id, channel, start_time DESC);
CREATE INDEX idx_videos_device_channel_end_time ON videos(device_id, channel, end_time DESC);
